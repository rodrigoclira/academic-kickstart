...
lastmod: 2026-05-01T08:18:25-03:00
featured: false
draft: false
...
Uma pergunta pulou em uma lista de e-mail que eu participo:

> Students love using copilot but how we make them learn code becasue learning a concept of programming is difficult. Student ask me why we learn basic [once] we ask ai to do that

Depois de analisar algumas respostas que foram dados para o questionamento do professor por professores de diferentes países, fiquei com curiosidade em saber o que os próprios modelos de linguagem poderiam responder, caso fossem indagados sobre isso. Resolvi usar o Claude (a minha LLM principal) para criar um prompt que pudesse responder esse questionamento.
...
Resolvi enviar o prompt para algumas LLMs mais conhecidas...
...
2. Eu erro — e às vezes de forma convincente.
...
* Segurança ofensiva (exploits)
Nesses casos, eu chuto com confiança e erro. Sem programação, você fica refém do meu chute.
